...
export default function Navbar() {
  ...
  return (
    <header
      className={cn(
        "top-0 left-0 right-0 z-50 w-full bg-white pointer-events-none py-3 h-[--nav-bar-height]",
        "md:top-3 md:bg-transparent",
      )}
    >
      <div className="relative mx-auto flex max-w-4xl md:max-w-full items-center justify-center px-5 py-3 sm:px-8 md:py-0 pointer-events-auto">
        ...
        <div className="flex flex-row items-center justify-between w-full">
          <div>
            <h1 className="text-xl text-destructive">CGPU</h1>
          </div>
          <NavigationMenu
            viewport={false}
          ...
          <div>
            <Button
              variant="outline"
              className="bg-primary-red text-white shadow-sm hover:bg-primary-red hover:text-white focus:bg-primary-red focus:text-white active:bg-primary-red active:text-white inline-flex h-9 w-max items-center justify-center px-4 py-2 text-sm font-medium transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
            >
              Report
            </Button>
          </div>
